...
from callback.carousel_callback import register_display_image, register_ca_update_slider, register_update_ca_play_btn, \
    ...
    register_ca_toggle_enable_btn, register_ca_download_csv
...
from callback.visualization_callback import \
    ...
    register_update_generate_btn_name, register_download_csv, register_update_export_place
...
register_update_export_place(app)
