...
def create_figure(data, parameter, ftype, toConfigure = True):
    if ftype == SCATTER_MAP:
        return create_scattermap(data,parameter, toConfigure)
    ...
    #     return create_scatter_geo(data,parameter)
        ...
        return create_density(data, parameter, toConfigure)
